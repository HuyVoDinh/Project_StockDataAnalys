...
if __name__ == '__main__':
    ...
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_3, columns=['vol_symbol_list_3'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_4, columns=['vol_symbol_list_4'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_5, columns=['vol_symbol_list_5'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_6, columns=['vol_symbol_list_6'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_7, columns=['vol_symbol_list_7'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)

    result_data = pd.DataFrame(vola_symbol_list_1, columns=['vola_symbol_list_1'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_2, columns=['vol_symbol_list_2'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(vol_symbol_list_3, columns=['vol_symbol_list_3'])
    ...
    result_data = pd.DataFrame(timing_symbol_list_1, columns=['timing_symbol_list_1'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(timing_symbol_list_2, columns=['timing_symbol_list_2'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(timing_symbol_list_3, columns=['timing_symbol_list_3'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(timing_symbol_list_4, columns=['timing_symbol_list_4'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(timing_symbol_list_5, columns=['timing_symbol_list_5'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)

    result_data = pd.DataFrame(short_symbol_list_1, columns=['short_symbol_list_1'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(short_symbol_list_2, columns=['short_symbol_list_2'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(short_symbol_list_3, columns=['short_symbol_list_3'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(short_symbol_list_4, columns=['short_symbol_list_4'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(short_symbol_list_5, columns=['short_symbol_list_5'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
    result_data = pd.DataFrame(short_symbol_list_6, columns=['short_symbol_list_6'])
    result_data.to_csv("""D:/Project/Project_StockDataAnalys/data.csv""", index=False)
